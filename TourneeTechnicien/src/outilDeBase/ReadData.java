...
public class ReadData {
	...
	public static double [][] lireMatriceTodouble(String fichier, int t1, int t2){	
	...
	public static int [][] lireMatriceToInt(String fichier, int t1, int t2){	
	...
	public static int [][] lireMatriceTW(String fichier, int t1, int t2){	
		int [][] mat=new int [t1][t2];
		//lecture du fichier texte	
		try{
			InputStream ips=new FileInputStream(fichier); 
	...
	public static int [] liretableau(String fichier, int t1){	
		int [] tab=new int [t1];
		//lecture du fichier texte	
		try{
			InputStream ips=new FileInputStream(fichier); 
	...
	public static void DonneeInit(String fichier){	
		//lecture du fichier texte	
		try{
			InputStream ips=new FileInputStream(fichier); 
			InputStreamReader ipsr=new InputStreamReader(ips);
	...
	public static void affichageMatrice (double [][] mat) {
	...
	public static void lancerLecture(String data){
